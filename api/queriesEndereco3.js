...
function createEndereco(req, res, next) {
  ...
  db.none('INSERT INTO public.endereco3(logradouro,numero,bairro,cidade,cep,uf,user_id)' +
...
function updateEndereco(req, res, next) {
  db.none('UPDATE public.endereco3 SET logradouro=$1, numero=$2, bairro=$3, cidade=$4, cep=$5, uf=$6 where id=$7',
