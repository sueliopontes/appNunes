...
function createEndereco(req, res, next) {
  ...
  db.none('INSERT INTO public.endereco2(logradouro,numero,bairro,cidade,cep,uf,user_id,complemento)' +
...
function updateEndereco(req, res, next) {
  db.none('UPDATE public.endereco2 SET logradouro=$1, numero=$2, bairro=$3, cidade=$4, cep=$5, uf=$6,complemento=$7 where id=$8',
